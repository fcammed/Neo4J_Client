package com.vector.service.zip.original;

import com.vector.service.zip.ParallelDeflaterOutputStream;
...
public class ZipOutputStream extends DeflaterOutputStream implements ZipConstants {
	...
	//Método nuevo
	public void closeEntry(long size, long csize, long crc) throws IOException {
		ensureOpen();
		if (current != null) {
